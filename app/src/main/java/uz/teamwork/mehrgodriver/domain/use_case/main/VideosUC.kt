...
class VideosUC @Inject constructor(private val repository: MainRepository, private val gson: Gson) {

    operator fun invoke(): Flow<Resource<BaseResponse<List<Video>>>> = flow {
