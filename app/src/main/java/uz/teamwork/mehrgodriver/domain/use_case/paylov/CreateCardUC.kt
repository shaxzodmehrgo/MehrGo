...
class CreateCardUC @Inject constructor(
    ...
    ): Flow<Resource<BaseResponse<CardCreateResult>>> = flow {
        emit(Resource.Loading)

        try {
            val response = repository.paylovCardCreate(cardNumber, expireDate, phoneNumber)
